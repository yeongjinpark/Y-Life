    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_son.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent mlntent_son= new Intent(Intent.ACTION_VIEW, Uri.parse("tel:/01046788337"));
        ...
        btn_dal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mlntent_dal= new Intent(Intent.ACTION_VIEW, Uri.parse("tel:/01046788337"));
        ...
        btn_emergency.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mlntent_emergency= new Intent(Intent.ACTION_VIEW, Uri.parse("tel:/01046788337"));
